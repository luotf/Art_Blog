    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="mailbox.html"><i class="fa fa-envelope"></i> <span class="nav-label">专栏设置</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a class="J_menuItem" href="mailbox.html">收件箱</a>
                            </li>
                            <li><a class="J_menuItem" href="mail_detail.html">查看邮件</a>
                            </li>
                            <li><a class="J_menuItem" href="${pageContext.request.contextPath}/admin/addBlog.jsp">写博客</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">数据图表</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">博客模块</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-flask"></i> <span class="nav-label">项目模块</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-table"></i> <span class="nav-label">资源模块</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-picture-o"></i> <span class="nav-label">评论模块</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a class="J_menuItem" href="css_animation.html"><i class="fa fa-magic"></i> <span class="nav-label">留言模块</span></a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-cutlery"></i> <span class="nav-label">前台页面 </span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="${pageContext.request.contextPath}/admin/table/blogTable.jsp">首页</a>
                    </div>
                </nav>
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="${pageContext.request.contextPath}/admin/table/blogTable.jsp" frameborder="0" data-id="${pageContext.request.contextPath}/admin/table/blogTable.jsp" seamless></iframe>
            </div>
            <div class="footer">
