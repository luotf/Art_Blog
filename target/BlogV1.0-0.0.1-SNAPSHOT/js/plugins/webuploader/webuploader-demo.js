jQuery(function() {
    ...
    function common_getPicFileList() {
        var params = "www.luotf.com\\webapps\\Blog\\upload";
        $.ajax({
            //此处使用的是自己封装的JAVA类
            url: "../getFileList",
            type: "POST",
            ...
            success: function (data) {
                ...
                for(var i=0;i<data.fileList.length;i++){
                	...
                	path="www.luotf.com/"+arr[1];
                	image=path.replace(/\\/g,'/');
                	pics+='<a class="fancybox" href="'+image+'"><img style="width: 254px; height: 143px;margin-right:5px;" alt="image" src="'+image+'" /></a>'
                	}
                }
				$(".pics").html(pics);
            },
